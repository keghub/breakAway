...
{
    public class DomainModelMapper : IEntityModelMapper 
    {
        ...
        private void MapReservation(EntityTypeConfiguration<Reservation> entity)
        {
            ...
            entity.HasRequired(e => e.Customer).WithMany().HasForeignKey(e => e.CustomerId);
        ...
        private void MapContact(EntityTypeConfiguration<Contact> entity)
        {
            ...
            entity.HasMany(k => k.Addresses).WithRequired(k => k.Contact).HasForeignKey(k => k.ContactId);
        ...
        {
            entity.Property(k => k.CustomerTypeId).HasColumnName("CustomerTypeID");
            ...
            entity.HasMany(k => k.Reservations).WithRequired().HasForeignKey(k => k.CustomerId);

            entity.Ignore(k => k.CustomerType);
